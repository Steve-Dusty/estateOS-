          ...
          <div className="px-5 pt-3 pb-0 flex gap-1">
            {(['overview', 'ads'] as const).map((t) => (
              <button
                key={t}
                onClick={() => setTab(t)}
                className="px-4 py-1.5 text-[11px] font-semibold rounded-sm transition-all capitalize flex items-center gap-1.5"
                style={{
            ...
            {tab === 'overview' && (
              <>
                ...
                <div className="flex gap-1.5">
                  ...
                  <button
                    onClick={() => setTab('ads')}
                    className="flex-1 py-2.5 text-[12px] font-semibold transition-all rounded-sm flex items-center justify-center gap-1.5"
