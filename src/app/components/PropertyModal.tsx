...
export default function PropertyModal({ property, onClose }: PropertyModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" onClick={onClose}>
      ...
      <div className="relative modal-enter w-[480px] max-h-[85vh] overflow-y-auto"
        style={{ background: 'white', border: '1px solid var(--border)', boxShadow: '0 16px 48px rgba(0,0,0,0.12)' }}
        ...
        <div className="relative h-[180px] overflow-hidden">
          ...
          <div className="absolute bottom-3 left-4">
            <span className="font-mono text-[24px] font-semibold text-white leading-none" style={{ textShadow: '0 1px 6px rgba(0,0,0,0.3)' }}>
        ...
        <div className="p-5">
          ...
          <div className="grid grid-cols-4 gap-1.5 mb-5">
            {[
              ...
              <div key={s.label} className="text-center py-3" style={{ background: 'var(--bg-body)' }}>
          ...
          <div className="grid grid-cols-2 gap-1.5 mb-5">
            <div className="p-3" style={{ background: 'var(--bg-body)' }}>
              ...
              <div className="h-[3px] overflow-hidden" style={{ background: 'var(--bg-muted)' }}>
                <div className="h-full" style={{ width: `${property.riskScore}%`, background: risk.color }} />
              </div>
            </div>
            <div className="p-3" style={{ background: 'var(--bg-body)' }}>
              <div className="flex items-center justify-between mb-2">
          ...
          <div className="space-y-px mb-5">
            {[
              ...
              <div key={r.label} className="flex items-center justify-between py-2 px-3" style={{ background: 'var(--bg-body)' }}>
          ...
          <div className="flex gap-1.5">
            <button className="flex-1 py-2.5 text-[12px] font-semibold cursor-pointer transition-opacity hover:opacity-90"
              style={{ background: 'var(--accent)', color: 'white' }}>
              Add to Portfolio
            </button>
            <button className="flex-1 py-2.5 text-[12px] font-semibold cursor-pointer transition-colors hover:bg-bg-muted"
